...
# Form implementation generated from reading ui file 'c:\UserData\flame_pixel_tool\LoginWindow.ui'
#
...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_3.setText(_translate("Form", "载入灯板布局文件"))
        self.pushButton_4.setText(_translate("Form", "载入灯效文件"))
